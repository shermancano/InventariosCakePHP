...
class ReportesController extends AppController {
	...
	function stock_excel($ceco_id, $tibi_id, $prod_id) {
		...
		$worksheet->write(10, 6, 'Stock Cr�tico (por CS/CC)', $format_head);
	...
	function stock_excel_activos_fijos($ceco_id, $tibi_id, $prod_id) {
		...
		$worksheet->write(10, 0, 'C�digo', $format_head);
		$worksheet->write(10, 1, 'Nombre', $format_head);
		...
		$worksheet->write(10, 6, 'Situaci�n', $format_head);
		$worksheet->write(10, 7, 'Marca', $format_head);
		$worksheet->write(10, 8, 'Color', $format_head);
		$worksheet->write(10, 9, 'Fecha Garant�a', $format_head);
		...
		$worksheet->write(10, 13, 'Vida �til', $format_head);
	...
	function productos_excel($tibi_id) {
		...
		$worksheet->write(10, 0, 'ID Producto', $format_head);
		$worksheet->write(10, 1, 'C�digo', $format_head);
			...
			foreach ($info as $key => $val) {
				if (sizeof($val) > 0) {
					...
					if ($key == "ACTIVOS FIJOS") {
						...
						$worksheet->write(10, 7, 'Situaci�n', $format_head);
						$worksheet->write(10, 8, 'Marca', $format_head);
						$worksheet->write(10, 9, 'Color', $format_head);
						$worksheet->write(10, 10, 'Fecha de Garant�a', $format_head);
	...
	function traslados_por_fechas_activos_fijos_excel($ceco_id, $ceco_id_hijo, $tibi_id, $fecha_desde, $fecha_hasta) {
		...
		$worksheet->write(10, 6, 'Propiedad', $format_head);
		$worksheet->write(10, 7, 'Color', $format_head);
		$worksheet->write(10, 8, 'Situaci�n', $format_head);
		$worksheet->write(10, 9, 'Modelo', $format_head);
		$worksheet->write(10, 10, 'Serie', $format_head);
		$worksheet->write(10, 11, 'Fecha Adquisici�n', $format_head);
		$worksheet->write(10, 12, 'Fecha Garant�a', $format_head);
	...
	function stock_centro_costo_excel($ceco_id) {
		...
		$worksheet->write(3, 1, 'Descripci�n', $format_head);
	...
	function stock_centro_costo_general_excel($ceco_id) {
		...
		$worksheet->write(3, 0, 'Descripci�n', $format_head);
	...
	function bajas_activos_fijos_excel($ceco_id = null, $prod_id = null, $fecha_desde = null, $fecha_hasta = null) {
		...
		$worksheet->write(3, 1, 'C�digo', $format_head);
		...
		$worksheet->write(3, 5, 'Vida �til', $format_head);
		$worksheet->write(3, 6, 'N�mero de Documento', $format_head);
		...
		$worksheet->write(3, 12, 'Observaci�n', $format_head);
	...
	function excel_trazabilidad($codigos_barra) {
		...
		$worksheet->write(9, 0, 'C�digo', $format_head);
		...
		$worksheet->write(9, 7, 'Situaci�n', $format_head);
		$worksheet->write(9, 8, 'Marca', $format_head);
		$worksheet->write(9, 9, 'Color', $format_head);
		$worksheet->write(9, 10, 'Fecha Garant�a', $format_head);
		...
		$worksheet->write(9, 14, 'Vida �til', $format_head);
		...
		//$worksheet->write(5, 0, "C�digo", $format_head);
	...
	function excel_depreciacion_producto($codigo_barra) {
		...
		// Titulo
		$worksheet->write(1, 0, "REPORTE DEPRECIACI�N POR PRODUCTO", $format_titulo);
		
		$worksheet->write(3, 0, "Producto", $format_head);
		$worksheet->write(3, 1, "C�digo de barra", $format_head);
		$worksheet->write(3, 2, "Propiedad", $format_head);
		$worksheet->write(3, 3, "Situaci�n", $format_head);
		$worksheet->write(3, 4, "Marca", $format_head);
		$worksheet->write(3, 5, "Color", $format_head);
		$worksheet->write(3, 6, "Fecha de Garant�a", $format_head);
		$worksheet->write(3, 7, "Fecha de adquisici�n", $format_head);
		$worksheet->write(3, 8, "Valor Libro", $format_head);
		$worksheet->write(3, 9, "IPC", $format_head);
		$worksheet->write(3, 10, "Correcci�n Monetaria", $format_head);
		$worksheet->write(3, 11, "Valor Corregido", $format_head);
		$worksheet->write(3, 12, "Valor Actual", $format_head);
		$worksheet->write(3, 13, "Depreciaci�n Acumulada Anterior", $format_head);
		$worksheet->write(3, 14, "Correcci�n Monetaria (depreciaci�n)", $format_head);
		$worksheet->write(3, 15, "Valor Corregido (depreciaci�n)", $format_head);
		$worksheet->write(3, 16, "Vida �til (pr�xima ejercicio)", $format_head);
		$worksheet->write(3, 17, "Valor a Depreciar", $format_head);
		$worksheet->write(3, 18, "Depreciaci�n", $format_head);
		$worksheet->write(3, 19, "Depreciaci�n Acumulada", $format_head);
		$worksheet->write(3, 20, "Valor Neto", $format_head);
		$worksheet->write(3, 21, "A�o", $format_head);
		$row_count = 4;			
		...
		foreach ($info as $row_) {
			...
			if ($row_['dede_vida_util_prox'] == 0) {
				...
				$worksheet->writeNote($row_count, 16, 'Finalizaci�n vida �til');
			}	
	...
	function mantenciones_excel($ubaf_codigo) {
		...
		$worksheet->write(3, 0, "C�digo", $format_titulo);
		...
		$worksheet->write(6, 0, "A�o", $format_titulo);
		...
		// Encabezado
		$worksheet->write(10, 0, "N�mero de Factura", $format_head);
		...
		$worksheet->write(10, 6, "Observaci�n", $format_head);
	...
	function financiamientos_excel($fina_id) {
		...
		$worksheet->write(3, 8, "Situaci�n", $format_head);
		...
		$worksheet->write(3, 12, "Vida �til", $format_head);
		$worksheet->write(3, 13, "Fecha de Garantia", $format_head);
		$worksheet->write(3, 14, "Fecha de Adquisici�n", $format_head);
