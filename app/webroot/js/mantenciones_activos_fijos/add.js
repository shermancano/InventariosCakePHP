...
$(document).ready(function(e) {
	...
	$('#add_mantencion').click(function() {
		...
		contenido += '	<td>';
		contenido += '		<div class="input text">';
		contenido += '			<input id="DetalleMantencion'+ count_fila +'DemaKilometraje" type="text" style="width:100%" name="data[DetalleMantencion]['+ count_fila +'][dema_kilometraje]" onkeypress="return validchars(event, num)" class="kilometraje">';
		contenido += '		</div>';
		contenido += '	</td>';
		contenido += '	<td>';
