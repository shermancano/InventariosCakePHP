...
<?php echo $this->Form->create('Grupo');?>
	...
	<?php
		...
		if (isset($this->data['Familia']['tifa_id'])) {
			echo $this->Form->input('tifa_id', array('value' => $this->data['Familia']['tifa_id'], 'after' => '&nbsp;<img id="tifa_loader" style="display:none;" src="/img/ajax-loader.gif" alt="0" />', 'label' => 'Tipo de Familia', 'options' => $tipos_familias, 'empty' => utf8_encode('-- Seleccione opción --')));
		} else {
