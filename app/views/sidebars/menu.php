...
<div class="actions">
	...
	<ul>
		...
		<li>
			<ul>
				<li><?php echo $this->Html->link(__(utf8_encode('A̱adir'), true), array('controller' => 'encargado_dependencias', 'action' => 'add')); ?></li>
			</ul>
		</li>
		<?php
			}
	...
	<ul>
		...
		<li>
			<ul>
				<li><?php echo $this->Html->link(__(utf8_encode('A̱adir'), true), array('controller' => 'encargado_inventarios', 'action' => 'add')); ?></li>
			</ul>
		</li>
		<?php
			}
	...
	<ul>
		...
		<li>
			<ul>
				<li><?php echo $this->Html->link(__(utf8_encode('A̱adir'), true), array('controller' => 'encargado_establecimientos', 'action' => 'add')); ?></li>
			</ul>
		</li>
		<?php
			}
