...
<div class="codigos_barra index">	
	<div class="cod_barra_tit">
		<span id="tit"><?php __(utf8_encode('Códigos de Barra'));?></span>
		<span id="exportar">        	
	...
	<tr>
			<th><?php echo $this->Paginator->sort(utf8_encode('Código'), 'UbicacionActivoFijo.ubaf_codigo');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__(utf8_encode('Generar Código'), true), array('action' => 'genera_codigo_barra', $deta['UbicacionActivoFijo']['ubaf_codigo']), array('target' => '_blank'), null); ?>
            <?php
