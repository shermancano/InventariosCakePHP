...
<div class="solicitudes index">
	<h2><?php __('Solicitudes Pendientes Externas');?></h2>
			...
			<?php
				if ($soli['EstadoSolicitud']['esso_id'] == 1) {
					...
					if (trim($soli['Solicitud']['prov_id']) != "") {
						echo "<a rel=\"".$soli['CentroCosto']['ceco_nombre']."|".$soli['Solicitud']['soli_id']."\" class=\"recepcionar\" href=\"javascript:;\"><img border=\"0\" alt=\"0\" title=\"Solicitud no recepcionada por proveedor ".$soli['Proveedor']['prov_nombre']."\" src=\"/img/test-fail-icon.png\" /></a>";
					}
				}
			?>
			&nbsp;
