<div class="gastos index">
	<h2><?php __('Encargados de Inventarios');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $resp['EncargadoInventario']['enin_id'])); ?>
			<?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $resp['EncargadoInventario']['enin_id']), null, __('La accion eliminara el encargado de inventario asociado al Centro de Costo, esta seguro que desea continuar?', true)); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
