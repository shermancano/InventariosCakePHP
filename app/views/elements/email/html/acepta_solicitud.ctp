...
<br />
<br />
La solicitud n&uacute;mero <strong><?php echo sprintf("%012d", $correlativo); ?></strong>, ha sido recepcionada con &eacute;xito por el <?php if ($prov_nombre != "") { echo "proveedor <strong>".$prov_nombre."</strong>"; } else { echo "Centro de Costo <strong>".$ceco_nombre_hijo."</strong>"; }?>.
<br />
<br />
