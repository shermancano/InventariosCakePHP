...
<?php echo $this->Form->create('CentroCosto', array('id' => 'CentroCostoEdit', 'url' => '/centros_costos/edit/'.$this->data['CentroCosto']['ceco_id']));?>
	...
	<?php
		...
		echo $this->Form->input('nied_id', array('label' => 'Nivel Educativo', 'empty' => utf8_encode('-- Seleccione Opción --'), 'options' => $nivelesEducativos));
	?>
	</fieldset>
    <fieldset>
    ...
    <?php
    	...
    	echo $this->Form->input('ceco_rut', array('label' => 'RUT o RBD'));
