...
<table border="0" width="100%">
	<tr>
		<td align="center" width="100%"><font size="5"><strong>REPORTE DE ACTIVOS FIJOS <?php echo utf8_decode($info_cc['CentroCosto']['ceco_nombre']);?></strong><font></td>
	</tr>
</table>
<br />
<table border="1" width="100%">
	...
	<tr>
        ...
        <td><?php echo utf8_decode($row['ubaf_serie']); ?>&nbsp;</td>
        <td><?php echo utf8_decode($row['hijo']); ?>&nbsp;</td>					
